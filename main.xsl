              ...
              <div role="contentinfo">
                ...
                <xsl:if test="$listType = 's'">
                  ...
                  <div>
                    ...
                    <iframe id="fb-button" referrerpolicy="no-referrer" sandbox="allow-scripts allow-popups" scrolling="no" src="//www.facebook.com/plugins/like.php?href={$permalink}&amp;width&amp;layout=box_count&amp;action=like&amp;show_faces=false&amp;share=true&amp;height=65&amp;appId=263583993673371"/>
		    <!--
                    <iframe id="gp-button" scrolling="no" src="//plusone.google.com/_/+1/fastbutton?size=tall&amp;hl=zh-TW&amp;url={$permalink}"/>
                    -->
                    <iframe id="tw-button" referrerpolicy="no-referrer" sandbox="allow-scripts allow-popups" scrolling="no" src="//platform.twitter.com/widgets/tweet_button.html?size=l&amp;count=vertical&amp;via=othree&amp;lang=zh-tw&amp;url={$permalink}"/>
