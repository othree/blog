...
<xsl:transform xmlns:html="http://www.w3.org/1999/xhtml" xmlns:b="http://blog.othree.net" xmlns:o="http://www.opml.org/spec2/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:taxo="http://purl.org/rss/1.0/modules/taxonomy/" xmlns:link="http://purl.org/rss/1.0/" xmlns:xsi="http://www.w3.org/2001/XMLSchema" xmlns:str="http://exslt.org/strings" version="2.0" extension-element-prefixes="str" xsi:schemaLocation="http://blog.othree.net http://blog.othree.net/blooog.xsd http://www.w3.org/1999/XSL/Transform xslt.xsd" xml:lang="en" exclude-result-prefixes="html b o xsi rdf link taxo str">
  ...
  <xsl:template match="b:blog">
    ...
    <xsl:if test="descendant::*[local-name() = 'blockquote'][@class = 'twitter-tweet']">
    ...
    <script type="application/ld+json">
      {
        ...
        "image": {
          "@type": "ImageObject",
            <xsl:choose><xsl:when test="starts-with(@src, '//')">
